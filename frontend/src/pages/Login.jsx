...
import { Mail, Lock, UserCheck, ChevronRight } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        <div className="premium-card p-10 glass dark:glass-dark shadow-2xl shadow-[var(--primary)]/5">
          <div className="text-center mb-10">
            ...
            <h2 className="text-4xl font-black text-[var(--foreground)] tracking-tight">Access Portal</h2>
            <p className="text-[var(--muted-foreground)] mt-2 font-medium">Re-engage with your evolution</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            >
              {loading ? (
                ...
                <>Sign In to Life <ChevronRight size={20} /></>
              )}
            </button>
          </form>
